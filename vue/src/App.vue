...
import MyModalManager from '@/components/modal/MyModalManager.vue';
...
const isExtensionRoute = computed(() => route.path.startsWith('/extension'));
</script>
...
<template>
  <div class="container-fluid position-relative">
    ...
    <!-- 只在小窗口上显示 -->
    <div v-if="!isExtensionRoute" class="content d-block d-md-none my-2 px-3 px-md-4 py-3">
      <h2 class="text-center fw-bold my-5">
        <font-awesome-icon :icon="faCircleExclamation" class="align-middle me-2" /> 请通过大屏幕设备访问本工具
      </h2>
    </div>
    <div v-else class="content d-block d-md-none my-2 px-3 px-md-4 py-3">
      <router-view />
    </div>
